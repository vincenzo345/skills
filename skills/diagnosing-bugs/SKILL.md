...
**Then ask: what would have prevented this bug?** If the answer involves architectural change—no good test seam, tangled callers, or hidden coupling—record a focused architecture follow-up with the evidence. Make the recommendation **after** the fix is in, when the diagnosis can inform it.
