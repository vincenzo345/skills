...
Grill the builder directly against the rules below. Keep this phase unforked: the phase is the
questions and evidence, not a dependency on another installed skill.
...
Apply the glossary rule below throughout, with **code cross-reference off and ADRs off.** The
vocabulary is the point. This skill holds no codebase model deliberately; repo exploration belongs
below the seam.
