...
- [`claude-rigor`](./skills/claude-rigor/SKILL.md) — install and inspect the direct-GitHub Claude Code harness that applies the validated operating contract, requires terminal diagnosis review before Workbench acceptance, and retains a one-shot completion backstop for unreviewed work.
